...
\textbf{*Mirar el tiempo que estuvo cayendo*}
...
\textbf{*Mirar los datos originales del prototipo 1 para comprobar el timestamp*}
  % Dependiendo del timestamp, cambiar la tabla para añadirlo, o indicar que en los datos orignales no hab´ia y por eso se inicializan
  %a cero para compararlos
...
duration of the battery is X, and if we want use this IoT system in people, specially in elderly people, or people
that need special treatment, we have to increase the duration of the battery in order to charge it as little as
possible.

The study has revealed that while we were studying the acceleration data, some of its values could be misinterpreted.
